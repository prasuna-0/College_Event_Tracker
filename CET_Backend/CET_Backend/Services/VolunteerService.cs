...
//                .Include(v => v.Student)
//                    .ThenInclude(s => s.User)   // explicitly refers to CET_Backend.Entities.User
...
//            return await _context.Volunteers
//                .Include(v => v.Student)
//                    .ThenInclude(s => s.User)   // same here
//                .Include(v => v.EventVolunteers)
//                    .ThenInclude(ev => ev.Event)
//                .Include(v => v.TeamVolunteers)
//                    .ThenInclude(tv => tv.Team)
...
//                SID = student.SID,
//                Student = student,
//                Name = student.User.Username,   // populate Name
...
//        public async Task<Volunteer?> UpdateVolunteerAsync(int id, int studentId)
//        {
...
//            volunteer.Name = student.User.Username;  // update Name
