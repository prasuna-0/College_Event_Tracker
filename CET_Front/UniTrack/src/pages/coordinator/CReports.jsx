...
const Reports = () => {
  ...
  return (
    <div style={{ padding: "20px", marginLeft: "120px", display: "flex", justifyContent: "center", marginTop: "35px" }}>
      <div style={{ width: "75%", maxWidth: "1000px",marginTop:"70px",marginRight:"120px" }}>
        ...
        {showPrintPreview && selectedEvent && (
          <div style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", zIndex: 999 }}>
            <div ref={printRef} style={{ backgroundColor: "white",marginTop:"150px",marginLeft:"160px",marginBottom:"120px", borderRadius: "8px", width: "70%", maxHeight: "90vh", overflowY: "auto", padding: "20px" }}>
              
              <h1 style={{marginTop:"80px"}}>Event Report</h1>
              ...
              <div className="section">
                <h2 style={{marginTop:"10px"}}>Budget Summary</h2>
