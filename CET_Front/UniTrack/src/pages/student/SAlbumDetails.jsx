...
//   const [selectedImage, setSelectedImage] = useState(null); // fullscreen state
...
//       setPhotos(res.data.photos); // backend बाट आएका photo array
//     } catch (err) {
//       console.error(err);
//     }
//   };
...
//       <h2 style={styles.title}>Album Photos</h2>
...
//             onClick={() => setSelectedImage(`http://localhost:5226${photo.filePath}`)}
//           />
//         ))}
//       </div>
...
//           <img src={selectedImage} alt="full" style={styles.fullImage} />
//         </div>
//       )}
//     </div>
//   );
